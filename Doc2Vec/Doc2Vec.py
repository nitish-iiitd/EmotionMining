...
if __name__ == "__main__":
	...
	sources = {"Anger_14k.txt": "Anger" , "Fear_14k.txt":"Fear" , "Joy_14k.txt": "Joy" , "Sadness_14k.txt" : "Sadness" , "Surprise_14k.txt" : "Surprise" }
	# sentences = LabeledLineSentence(sources)
	# model = Doc2Vec(min_count=1, window=10, size=100, sample=1e-4, negative=5, workers=7)
	# model.build_vocab(sentences.to_array())
	# for epoch in range(10):
		# model.train(sentences.sentences_perm(), total_examples = model.corpus_count, epochs = model.iter)
	# model.save("TrainedModel_14k.pkl")
	model = Doc2Vec.load("TrainedModel_14k.pkl")
	...
	dict = {"Anger":14000 , "Fear":14000 , "Joy":14000 , "Sadness":14000 , "Surprise":14000 }
	k =0
	l = 0
